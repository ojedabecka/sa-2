...
module.exports = app => {
    ...
    app
        ...
        .post('/addVendedor', auth.authenticate, controller.createVendedor)
        // GET PET BY ID ? {{respTemplate}} : {'message'}
        .get('/vendedor/:id', auth.authenticate, controller.getVendedor)
        // GET ALL PETS ? {{respTemplate}} : {'message'}
        .get('/vendedores', auth.authenticate, controller.getVendedores)
